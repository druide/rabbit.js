...
function PubSocket(channel, opts) {
  Writable.call(this, {objectMode: opts.objectMode});
...
function SubSocket(channel, opts) {
  Readable.call(this, {objectMode: opts.objectMode});
  ...
  var setup = channel.then(function(ch) {
    ...
    return ch.assertQueue(queueName, {
      exclusive: !opts.persistent, autoDelete: !opts.persistent, durable: opts.persistent
    }).then(function(ok) {
...
function PullSocket(channel, opts) {
  Readable.call(this, {objectMode: opt.objectMode});
  Socket.call(this, channel, opts);
  this.consumers = {};
}
...
function ReqSocket(channel, opts) {
  Duplex.call(this, {objectMode: opts.objectMode});
  this.queues = [];
  this.awaiting = [];
  this.replyQ = null;
